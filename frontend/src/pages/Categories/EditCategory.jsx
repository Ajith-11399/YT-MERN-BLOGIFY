...
const EditCategory = () => {
    ...
    const { data:categoryData, loading, error } = useFetch(`${getEnv('VITE_BACKEND_URL')}/category/show/${category_id}`,{
        method: 'get',
        credentials: 'include',
    } ,[category_id]);
    ...
    const onSubmit = async(values) => {
        try {
            ...
            const response = await fetch(`${getEnv('VITE_BACKEND_URL')}/category/update/${category_id}`, {
                method: 'put',
            ...
            <Card className='w-full max-w-screen-md shadow-lg rounded-lg space-y-3 border-none p-5'>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <div className='mt-5'>
                            <Button type="submit" className='w-[200px] hover:scale-105 hover:transition-all hover:duration-300'>Update Category</Button>
                        </div>
                    </form>
                </Form>
