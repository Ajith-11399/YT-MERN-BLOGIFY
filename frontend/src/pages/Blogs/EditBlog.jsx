...
const EditBlog = () => {
    ...
    const { data: blogData, loading: blogLoading } =  useFetch(`${getEnv('VITE_BACKEND_URL')}/blog/show/${blogid}`, {
        method: 'get',
        credentials: 'include',
    }, [blogid]);
    ...
    useEffect(()=> {
        if(blogData){
            ...
            form.setValue('featuredImage', blogData.blog.featuredImage);
    ...
    const onSubmit = async(values) => {
        ...
        try {
            ...
            const response = await fetch(`${getEnv('VITE_BACKEND_URL')}/blog/update/${blogid}`, {
                method: 'put',
                credentials: 'include',
                body: formData
            });
    ...
    return (
        ...
        <div className='flex justify-center items-center'>
            ...
            <Card className='w-full shadow-lg rounded-lg space-y-3 border-none p-5'>
                ...
                <p className='text-2xl font-medium text-center'> Update Blog </p>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <div className='mt-5'>
                            <Button type="submit" className='w-[200px] hover:scale-105 hover:transition-all hover:duration-300'>Update Blog</Button>
                        </div>
                    </form>
                </Form>
